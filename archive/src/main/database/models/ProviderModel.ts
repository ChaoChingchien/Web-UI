...
import type { AIProvider, ProviderType, WebAutomationConfig, ApiConfig } from '@shared/types';
...
export class ProviderModel {
  ...
  static create(data: Partial<AIProvider>): AIProvider {
    ...
    db.run(
      `INSERT INTO providers (id, name, icon, type, is_custom, is_enabled, url, web_config, api_config, local_config, created_at, updated_at)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [
